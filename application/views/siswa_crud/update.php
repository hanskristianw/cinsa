            ...
            <form class="user" method="post" action="<?= base_url('Siswa_CRUD/update'); ?>">
              <div class="form-group row">
                <div class="col-sm mb-3 mb-sm-0">
                  ...
                  <input type="text" class="form-control" id="sis_no_induk" name="sis_no_induk" placeholder="NIS" value="<?= set_value('sis_no_induk', $siswa_update['sis_no_induk']) ?>" disabled="disabled">
