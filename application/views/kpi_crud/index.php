...
<div class="grid-main">
  ...
  <div class="box1">
    <form action="<?= base_url('KPI_CRUD/add') ?>" method="post">
    ...
    <table class="table table-bordered table-hover table-sm" style="font-size:14px;">
      <thead class="thead-dark">
        <tr>
          ...
          <th class="pt-4 pb-4 pl-2" style="width:5%;">Bobot(%)</th>
      ...
      <tbody>
        ...
        ?>
          <tr>
            <td><?= $m['kompe_kpi_nama'] ?></td>
            <td><?= $m['kompe_kpi_bobot'] ?></td>
            <td>
              <?php
                $indi = explode(";;",$m['indi_kpi_nama']);
              ?>
                <?php
                  if($indi[0]):
                  foreach ($indi as $i):
            ...
            <td class="text-center">
              <form class="" action="<?= base_url('KPI_CRUD/edit') ?>" method="post">
            ...
            <td class="text-center">
              <form class="" action="<?= base_url('KPI_CRUD/delete') ?>" method="post">
                <input type="hidden" name="kompe_kpi_id" value=<?= $m['kompe_kpi_id'] ?>>
