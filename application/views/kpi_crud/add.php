...
<div class="grid-container">
  ...
  <div class="box1">
    ...
    <form class="" action="<?= base_url('KPI_CRUD/add_proses'); ?>" method="post">

      <input type="hidden" name="jabatan_kpi_id" value="<?= $jabatan_kpi_id ?>">
      <input type="hidden" name="t_id" value="<?= $t_id ?>">

      <label style="font-size:14px;"><b>Nama Kompetensi:</b></label>
      <input type="text" class="form-control form-control-sm mb-3" name="kompe_kpi_nama" value="" required>

      <label style="font-size:14px;"><b>Bobot Kompetensi dalam persen:</b></label>
      <input type="number" class="form-control form-control-sm mb-3" name="kompe_kpi_bobot" required>
