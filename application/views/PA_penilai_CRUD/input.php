...
<div class="grid-main">
  ...
  <div class="box1 text-center mt-4 mb-4"><h4><u>PERFORMANCE APPRAISAL (PA) <?= strtoupper($jab['jabatan_kpi_nama']) ?></u></h4></div>
  ...
  <div class="box1">
    ...
    <?php if($kr_dinilai['kr_google_drive']!="#"): ?>
      <div class="alert alert-warning mt-1 text-center" role="alert" style="font-size:13px;">
        Link media pembelajaran klik <a href="<?= $kr_dinilai['kr_google_drive'] ?>" >disini</a>
      </div>
    <?php endif; ?>
