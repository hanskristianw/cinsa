...
<div class="grid-main">
  ...
  <div class="box1 text-center mt-4"><h4><u>Hapus Ujian</u></h4></div>
  ...
  <div class="box1 mb-4">
    ...
    <?php if($mapel_all): ?>
      <form class="" action="<?= base_url('Hapus_Nilai_Mapel/hasil_ujian'); ?>" method="post">

        <input type="hidden" name="kelas_id" value="<?= $kelas_id ?>">

        <label class="mt-3"><b>Mapel:</b></label>
        <select name="mapel_id" class="form-control form-control-sm">
          <?php
            foreach ($mapel_all as $t) :
              echo "<option value=" . $t['mapel_id'] . ">" . $t['mapel_nama'] . "</option>";
            endforeach
          ?>
        </select>
