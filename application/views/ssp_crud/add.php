        ...
        <div class="row">
            ...
            <div class="p-5">
                <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Insert SSP</h1>
                </div>
                ...
                <form class="user" method="post" action="<?= base_url('SSP_CRUD/add'); ?>">
                    <div class="form-group row">
                        <div class="col-sm mb-3 mb-sm-0">
                            <input type="text" class="form-control" id="ssp_nama" name="ssp_nama" placeholder="SSP Name (Ex: ROBOTIC)" value="<?= set_value('ssp_nama') ?>">
