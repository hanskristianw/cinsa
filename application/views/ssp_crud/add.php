                ...
                <form class="user" method="post" action="<?= base_url('SSP_CRUD/add'); ?>">
                    <div class="form-group row">
                        <div class="col-sm mb-3 mb-sm-0">
                            <input type="text" class="form-control form-control-sm" id="ssp_nama" name="ssp_nama" placeholder="Name (Ex: ROBOTIC)" value="<?= set_value('ssp_nama') ?>">
                        ...
                        <div class="col-sm mb-sm-0">
                            <select name="ssp_t_id" id="ssp_t_id" class="form-control form-control-sm">
                                <?php 
