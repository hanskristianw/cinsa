        ...
        <div class="col-lg">
          <div class="p-5 overflow-auto">
            ...
            <div class="alert alert-info alert-dismissible fade show">
              ...
              <ul>
                <li>Klik nilai cognitive, psychomotor dan nilai akhir untuk melihat detail perhitungan</li>
                <li>Pastikan wakakur telah melakukan set pengajar CB pada setting kelas, jika tidak, nama guru CB tidak akan muncul</li>
              </ul>
            </div>
              ...
              ?>
                  ...
                  <div id='textbox'>
                    <p class='alignleft_bawah'>
                      ...
                      Parents / Guardian<br><br><br><br><br>
                      ............................................
                    </p>

                    <p class='alignright_bawah'>
                      <br>Surabaya, <?= $bulan . ' ' . $tanggal . ', ' . $tahun ?><br>
                      Homeroom Teacher<br><br><br><br><br>
                      <b><?= $walkel['kr_gelar_depan'] . $walkel['kr_nama_depan'] . ' ' . $walkel['kr_nama_belakang'] . " " . $walkel['kr_gelar_belakang'] ?></b><br>
                    </p>
                  </div>
                  <div style='clear: both;'></div>

                  <p class='aligncenter_bawah'>Acknowledged by<br>Principal<br><br><br><br><br><b><?= $kepsek['kr_gelar_depan'] . $kepsek['kr_nama_depan'] . ' ' . $kepsek['kr_nama_belakang'] . " " . $kepsek['kr_gelar_belakang'] ?></b></p>
                  ...
                  <table class='rapot'>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td style='padding: 0px 0px 0px 5px;font-size:11px;height: 10px;'>Physical Fitness and Healthful Habit</td>
                        <td style='padding: 0px 0px 0px 10px;height: 10px;'><b><?= return_abjad_base4($pfhf_nilai) ?></b></td>
                      </tr>
                      <tr>
                        <?php
                        $mb_nilai = 0;
                        ...
                        ?>
                        <td style='text-align: center;height: 10px;'>2</td>
                        <td style='padding: 0px 0px 0px 5px;height: 10px;'>Moral Behavior</td>
                        <td style='padding: 0px 0px 0px 10px;height: 10px;'><b><?= return_abjad_base4($mb_nilai) ?></b></td>
                      </tr>
                      <tr>
                        <?php
                        $emo_nilai = 0;
                        ...
                        <td style='padding: 0px 0px 0px 5px;height: 10px;'>Emotional Awareness</td>
                        <td style='padding: 0px 0px 0px 10px;height: 10px;'><b><?= return_abjad_base4($emo_nilai) ?></b></td>
                      </tr>
                      <tr>
                        <?php
                        $spirit_nilai = 0;
                        ...
                        ?>
                        <td style='text-align: center;height: 10px;'>4</td>
                        <td style='padding: 0px 0px 0px 5px;height: 10px;'>Spirituality</td>
                        <td style='padding: 0px 0px 0px 10px;height: 10px;'><b><?= return_abjad_base4($spirit_nilai) ?></b></td>
                      </tr>
                      <tr>
                        <?php
                        $ss_nilai = 0;
                        ...
                        <td style='padding: 0px 0px 0px 5px;height: 10px;'>Social Skill</td>
                        <td style='padding: 0px 0px 0px 10px;height: 10px;'><b><?= return_abjad_base4($ss_nilai) ?></b></td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <table class='rapot'>
                    <tbody>
                      <tr>
                        <td style='text-align: center; width: 30px; padding: 0px 0px 0px 0px;height: 10px;'><?= $no_self_d ?></td>
                        <td style='width: 185px; padding: 0px 0px 0px 5px;height: 10px;'>Character Building</td>
                        <td style='padding: 0px 0px 0px 10px;height: 10px;'><b><?= $nilai_cb ?></b></td>
                      </tr>
                      <?php
                      if ($checkSsp) :
                        $no_self_d++;
                      ?>
                        <tr>
                          <td style='text-align: center;height: 10px;'><?= $no_self_d ?></td>
                          <td style='padding: 0px 0px 0px 5px;height: 10px;'><?= ucfirst(strtolower($nama_ssp)) ?></td>
                          <td style='padding: 0px 0px 0px 10px;height: 10px;'><b><?= $nilai_ssp ?></b></td>
                        </tr>
                      <?php
                      endif;
                      ?>
                      ...
                      ?>
                        <tr>
                          <td style='text-align: center;height: 10px;'><?= $no_self_d ?></td>
                          <td style='padding: 0px 0px 0px 5px;height: 10px;'>Scout</td>
                          <td style='padding: 0px 0px 0px 10px;height: 10px;'><b><?= return_abjad_base4($scout_nilai) ?></b></td>
                        </tr>
                      <?php
                      endif;
                      ?>
                  ...
                  <table class='rapot'>
                    <tbody>
                      <tr>
                        <td style='text-align: center; width: 30px; padding: 0px 0px 0px 0px;height: 10px;'>1</td>
                        <td style='width: 185px; padding: 0px 0px 0px 5px;height: 10px;'>Sick</td>
                        <?php
                        $sick = "";
                        if ($semester == 1)
                        ...
                        if ($sick == "0")
                          $sick = "-";
                        ?>
                        <td style='padding: 0px 0px 0px 10px;height: 10px;'><?= $sick ?> day(s)</td>
                      </tr>
                      <tr>
                        <td style='text-align: center;height: 10px;'>2</td>
                        <td style='padding: 0px 0px 0px 5px;height: 10px;'>Absent (Including Excuse)</td>
                        <?php
                        $absenin = "";
                        if ($semester == 1)
                        ...
                        if ($absenin == "0")
                          $absenin = "-";
                        ?>
                        <td style='padding: 0px 0px 0px 10px;height: 10px;'><?= $absenin ?> day(s)</td>
                      </tr>
                      <tr>
                        <td style='text-align: center;height: 10px;'>3</td>
                        <td style='padding: 0px 0px 0px 5px;height: 10px;'>Absent (Excluding Excuse)</td>
                        <?php
                        $absenex = "";
                        if ($semester == 1)
                        ...
                        if ($absenex == "0")
                          $absenex = "-";
                        ?>
                        <td style='padding: 0px 0px 0px 10px;height: 10px;'><?= $absenex ?> day(s)</td>
                      </tr>
                      <tr>
