                        ...
                        <form class="user" method="post" action="<?php echo base_url('Karyawan_CRUD/update'); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="kr_nama_belakang" name="kr_nama_belakang" value="<?= set_value('kr_nama_belakang', $kr_update['kr_nama_belakang']); ?>">
