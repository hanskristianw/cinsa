                ...
                <form class="user" method="post" action="<?php echo base_url('Karyawan_CRUD/update'); ?>">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" class="form-control form-control-sm" id="kr_nama_depan" name="kr_nama_depan" value="<?= set_value('kr_nama_depan',$kr_update['kr_nama_depan']); ?>" required>
                        </div>
                        <div class="col-sm-6">
                            <label for="kr_nama_belakang"><b><u>Last Name</u>:</b></label>
                            <input type="text" class="form-control form-control-sm" id="kr_nama_belakang" name="kr_nama_belakang" value="<?= set_value('kr_nama_belakang',$kr_update['kr_nama_belakang']); ?>" required>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <select name="kr_jabatan_id" id="kr_jabatan_id" class="form-control form-control-sm">
                                <?php
                            ...
                            <select name="kr_sk_id" id="kr_sk_id" class="form-control form-control-sm">
                                <?php
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <div class="form-group row mt-2">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <select name="kr_pendidikan_skrng" id="kr_pendidikan_skrng" class="form-control form-control-sm">
                                    <?php
