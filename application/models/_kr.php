...
class _kr extends CI_Model {
  ...
  public function return_all_except_admin(){
    return $this->db->join('sk','kr_sk_id=sk_id','Left')->join('jabatan','kr_jabatan_id=jabatan_id','Left')->where('kr_jabatan_id >', '1')->order_by("kr_nama_depan", "ASC")->get('kr')->result_array();
  }
