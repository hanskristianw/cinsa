...
class _kr extends CI_Model {
  ...
  public function return_all_except_admin(){
    return $this->db->join('jabatan','kr_jabatan_id=jabatan_id','Left')->join('st','kr_st_id=st_id','Left')->where('kr_jabatan_id >', '1')->order_by("kr_nama_depan", "ASC")->get('kr')->result_array();
  }
