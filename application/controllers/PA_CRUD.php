...
class PA_CRUD extends CI_Controller
{
  ...
  public function tahun(){
    ...
    if($this->input->get('jabatan_kpi_id')){
      ...
      $this->load->view('PA_CRUD/tahun', $data);
  ...
  public function index()
  {
    if($this->input->get('jabatan_kpi_id')){
      ...
      $data['title'] = 'Kompetensi PA untuk '.$jb['jabatan_kpi_nama'].' '.$t_cek['t_nama'];
      $data['jabatan_kpi_id'] = $jabatan_kpi_id;
  ...
  public function add(){
    if($this->input->post('jabatan_kpi_id')){
      ...
      $data['title'] = 'Tambah Kompetensi PA '.$jb['jabatan_kpi_nama'] .' untuk tahun '.$t_cek['t_nama'];
  ...
  public function add_proses(){
    if($this->input->post('kompe_pa_nama')){
      $data = [
        ...
        'kompe_pa_t_id' => $this->input->post('t_id'),
      ];
      ...
      redirect('PA_CRUD?jabatan_kpi_id='.$this->input->post('jabatan_kpi_id').'&t_id='.$this->input->post('t_id'));
    }
  }
